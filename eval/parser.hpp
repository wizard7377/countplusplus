...
/**
 ** \file /root/linPro/disBots/countBot/eval/parser.hpp
...
#ifndef YY_YY_ROOT_LINPRO_DISBOTS_COUNTBOT_EVAL_PARSER_HPP_INCLUDED
# define YY_YY_ROOT_LINPRO_DISBOTS_COUNTBOT_EVAL_PARSER_HPP_INCLUDED
// "%code requires" blocks.
#line 11 "/root/linPro/disBots/countBot/eval/parser.yy"

  # include <string>
  class driver;

#line 54 "/root/linPro/disBots/countBot/eval/parser.hpp"
...
namespace yy {
#line 194 "/root/linPro/disBots/countBot/eval/parser.hpp"
...
switch (yykind)
    ...
    struct symbol_type : basic_symbol<by_kind>
    {
...
#endif
      {
        ...
        YY_ASSERT (tok == token::TOK_YYEOF
                   ...
                   || tok == token::TOK_MUL
                   || tok == 42
                   || (token::TOK_IF <= tok && tok <= token::TOK_RPAR)
                   || (token::TOK_INF <= tok && tok <= token::TOK_EOLINE));
#endif
      }
#if 201103L <= YY_CPLUSPLUS
      ...
      {
#if !defined _MSC_VER || defined __clang__
        YY_ASSERT ((token::TOK_STR <= tok && tok <= token::TOK_ID));
#endif
      }
    };
    ...
    // Implementation of make_symbol for each token kind.
      ...
      {
        return symbol_type (token::TOK_INF, std::move (l));
      }
#else
      static
      symbol_type
      ...
      {
        return symbol_type (token::TOK_INF, l);
      }
#endif
#if 201103L <= YY_CPLUSPLUS
      static
      ...
      static
      symbol_type
      make_OUTF (location_type l)
      {
        return symbol_type (token::TOK_OUTF, std::move (l));
      }
#else
      static
      symbol_type
      make_OUTF (const location_type& l)
      {
        return symbol_type (token::TOK_OUTF, l);
      }
#endif
#if 201103L <= YY_CPLUSPLUS
      static
      symbol_type
      make_EOLINE (location_type l)
      {
        return symbol_type (token::TOK_EOLINE, std::move (l));
      }
#else
      static
      symbol_type
      make_EOLINE (const location_type& l)
      {
        return symbol_type (token::TOK_EOLINE, l);
      }
#endif
...
#line 1656 "/root/linPro/disBots/countBot/eval/parser.hpp"




#endif // !YY_YY_ROOT_LINPRO_DISBOTS_COUNTBOT_EVAL_PARSER_HPP_INCLUDED
